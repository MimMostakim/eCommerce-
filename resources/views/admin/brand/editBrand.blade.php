                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                {{Form::hidden('id',$brand->id,['class'=>'form-control','placeholder'=>'Enter Brand Name'])}}
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <img src="{{asset($brand->brand_image)}}" width="200">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {{Form::select('status',[''=>'Select Status','1'=>'Published','0'=>'Unpublished'],$brand->status == 1?'1':'0',['class'=>'form-control'])}}
                            </div>
                        </div>
                        <div class="form-group row">
