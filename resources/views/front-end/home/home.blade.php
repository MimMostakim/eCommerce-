                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset($product->pro_image)}}" alt="" height="200">
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="single.html">{{$product->pro_name}}</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                                <span class="item_price">Tk. {{$product->pro_discount}}</span>
                                                <del>Tk. {{$product->pro_price}}</del>
                                            </div>
                                ...
                                <div class="scroll">
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{asset('/frontend')}}/images/k1.jpg" alt="" class="img-fluid">
                                        </div>
                                    ...
                                    <div class="row my-4">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{asset('/frontend')}}/images/k2.jpg" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{asset('/frontend')}}/images/k3.jpg" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
